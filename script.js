...
const levels = [
    ...
    [
         ...
         [EMPTY, RED, EMPTY, RED, GREEN, GREEN],
         [EMPTY, KEY, KEY, RED, RED, EMPTY],
         [RED, GREEN, GREEN, GREEN, RED, RED],
         [RED, EMPTY, RED, GREEN, GREEN, RED],
         [EMPTY, EMPTY, RED, EMPTY, EMPTY, RED]
    ],
    [
         [EMPTY, RED, GREEN, GREEN, GREEN+'2', GREEN+'2'],
         [EMPTY, RED, GREEN, GREEN, GREEN, RED],
    ...
    [
         [RED, EMPTY, GREEN, GREEN, EMPTY, EMPTY],
         [RED, EMPTY, RED, EMPTY, RED, EMPTY],
         [KEY, KEY, RED, RED, RED, EMPTY],
    ...
    [
         [EMPTY, RED, GREEN, GREEN, GREEN, EMPTY],
         [EMPTY, RED, RED, RED, GREEN, GREEN],
         [KEY, KEY, RED, RED, EMPTY, RED],
         [EMPTY, RED, GREEN, GREEN, GREEN, RED],
         [EMPTY, RED, RED, EMPTY, GREEN, GREEN],
         [GREEN, GREEN, RED, EMPTY, EMPTY, EMPTY]
    ],
    [
         [EMPTY, EMPTY, EMPTY, EMPTY, GREEN, GREEN],
         [EMPTY, GREEN, GREEN, RED, RED, EMPTY],
         [RED, KEY, KEY, RED, RED, RED],
         [RED, GREEN, GREEN, GREEN, RED, RED],
         [RED, EMPTY, RED, GREEN, GREEN, RED],
         [GREEN, GREEN, RED, EMPTY, GREEN, GREEN]
    ],
    [
         [EMPTY, RED, EMPTY, GREEN, GREEN, EMPTY],
         [EMPTY, RED, GREEN, GREEN, RED, RED],
         [EMPTY, KEY, KEY, RED, RED, RED],
         [RED, GREEN, GREEN, RED, RED, EMPTY],
         [RED, EMPTY, RED, GREEN, GREEN, RED],
         [RED, EMPTY, RED, EMPTY, EMPTY, RED]
    ],
    [
         [EMPTY, EMPTY, GREEN, GREEN, GREEN, RED+'2'],
         [GREEN, GREEN, RED, EMPTY, RED, RED+'2'],
         [KEY, KEY, RED, EMPTY, RED, RED],
         [RED, RED, GREEN, GREEN, RED, RED],
         [RED, RED, EMPTY, RED, EMPTY, RED],
         [EMPTY, RED, EMPTY, RED, GREEN, GREEN]
    ],
    [
         [RED+'2', EMPTY, EMPTY, GREEN, GREEN, EMPTY],
         [RED+'2', GREEN, GREEN, EMPTY, RED, RED],
         [RED, EMPTY, KEY, KEY, RED, RED],
         [RED, GREEN, GREEN, EMPTY, RED, EMPTY],
         [EMPTY, EMPTY, RED, GREEN, GREEN, RED],
         [GREEN, GREEN, RED, EMPTY, EMPTY, RED]
    ],
    [
         ...
         [RED, RED, KEY, KEY, RED, EMPTY],
         [RED, GREEN, GREEN, EMPTY, RED, EMPTY],
         [EMPTY, EMPTY, RED, GREEN, GREEN, GREEN],
         [EMPTY, EMPTY, RED, EMPTY, EMPTY, EMPTY]
    ],
    [
         [EMPTY, EMPTY, GREEN, GREEN, GREEN, EMPTY],
    ...
    [
         [EMPTY, GREEN+'2', GREEN+'2', GREEN, GREEN, GREEN],
         [EMPTY, EMPTY, RED, RED, GREEN, GREEN],
         [KEY, KEY, RED, RED, EMPTY, RED],
         [EMPTY, RED, GREEN, GREEN, GREEN, RED],
         [EMPTY, RED, RED, EMPTY, GREEN, GREEN],
    ...
    [
         ...
         [EMPTY, EMPTY, RED, GREEN, GREEN, RED],
         [KEY, KEY, RED, RED, RED, EMPTY],
         [GREEN, GREEN, GREEN, RED, RED, EMPTY],
         [RED, GREEN, GREEN, GREEN, RED, RED],
         [RED, EMPTY, EMPTY, GREEN, GREEN, RED]
    ],
    [
         [EMPTY, RED, EMPTY, RED, GREEN, GREEN],
         [EMPTY, RED, EMPTY, RED, RED, EMPTY],
...
         [EMPTY, EMPTY, RED, RED, EMPTY, RED],
         [RED, KEY, KEY, RED, EMPTY, RED],
         [RED, RED, EMPTY, RED, GREEN, GREEN],
         [RED, RED, GREEN, GREEN, RED, EMPTY],
         [GREEN, GREEN, GREEN, EMPTY, RED, EMPTY]
    ],
    [
         [EMPTY, RED, GREEN, GREEN, GREEN+'2', GREEN+'2'],
         [EMPTY, RED, RED, EMPTY, RED, RED],
         [KEY, KEY, RED, EMPTY, RED, RED],
         [RED, GREEN, GREEN, RED, RED, EMPTY],
         [RED, EMPTY, EMPTY, RED, GREEN, GREEN],
         [GREEN, GREEN, GREEN, RED, EMPTY, EMPTY]
...
         [RED, RED, GREEN, GREEN, RED, EMPTY],
         [RED, RED, KEY, KEY, RED, RED],
         [GREEN, GREEN, RED, EMPTY, RED, RED],
         [EMPTY, EMPTY, RED, GREEN, GREEN, RED+'2'],
         [GREEN, GREEN, GREEN, EMPTY, EMPTY, RED+'2']
    ],
    [
         [GREEN, GREEN, EMPTY, RED, EMPTY, EMPTY],
         [EMPTY, RED, EMPTY, RED, GREEN, GREEN],
         [EMPTY, RED, KEY, KEY, RED, RED],
         [RED, GREEN, GREEN, RED, RED, RED],
         [RED, EMPTY, EMPTY, RED, GREEN, GREEN],
         [RED, GREEN, GREEN, GREEN, EMPTY, EMPTY]
    ],
    [
         [RED, RED, EMPTY, EMPTY, RED, EMPTY],
         [RED, RED, GREEN, GREEN, RED, EMPTY],
         [KEY, KEY, RED, EMPTY, RED, EMPTY],
         [RED, EMPTY, RED, GREEN, GREEN, RED],
         [RED, GREEN, GREEN, RED, EMPTY, RED],
         [GREEN, GREEN, EMPTY, RED, EMPTY, RED]
    ],
    [
         [EMPTY, GREEN, GREEN, EMPTY, EMPTY, EMPTY],
         [GREEN, GREEN, RED, EMPTY, GREEN, GREEN],
         [EMPTY, RED, RED, KEY, KEY, RED],
         [RED, RED, GREEN, GREEN, GREEN, RED],
         [RED, GREEN, GREEN, RED, EMPTY, RED],
         [RED, EMPTY, EMPTY, RED, GREEN, GREEN]
    ],
    [
         [EMPTY, EMPTY, GREEN, GREEN, GREEN+'2', GREEN+'2'],
         [EMPTY, EMPTY, EMPTY, RED, RED, EMPTY],
         [RED, KEY, KEY, RED, RED, RED],
         [RED, RED, GREEN, GREEN, RED, RED],
         [EMPTY, RED, RED, GREEN, GREEN, RED],
         [EMPTY, RED, RED, GREEN, GREEN, GREEN]
    ],
   [
         [EMPTY, RED, EMPTY, EMPTY, GREEN, GREEN],
         [EMPTY, RED, GREEN, GREEN, GREEN, RED],
   ...
   [
         [EMPTY, RED, GREEN, GREEN, GREEN+'2', GREEN+'2'],
         [EMPTY, RED, EMPTY, EMPTY, RED, EMPTY],
         [EMPTY, RED, KEY, KEY, RED, RED],
         [GREEN, GREEN, RED, EMPTY, RED, RED],
         [RED, EMPTY, RED, GREEN, GREEN, RED],
         [RED, GREEN, GREEN, EMPTY, EMPTY, RED]
